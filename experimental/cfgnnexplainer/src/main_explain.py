...
with open("experimental/cfgnnexplainer/data/gnn_explainer/{}.pickle".format(args.dataset[:4]), "rb") as f:
	data = pickle.load(f)
...
model.load_state_dict(torch.load("experimental/cfgnnexplainer/models/gcn_3layer_{}.pt".format(args.dataset)))
model.eval()
...
with safe_open("experimental/cfgnnexplainer/results/{}/{}/{}_cf_examples_lr{}_beta{}_mom{}_epochs{}_seed{}".format(args.dataset, args.optimizer, args.dataset,
