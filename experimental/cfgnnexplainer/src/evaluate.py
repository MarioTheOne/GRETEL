...
with open("experimental/cfgnnexplainer/data/gnn_explainer/{}.pickle".format(dataset), "rb") as f:
	data = pickle.load(f)
...
model.load_state_dict(torch.load("experimental/cfgnnexplainer/models/gcn_3layer_{}.pt".format(dataset)))
model.eval()
...
# Load CF examples
with open("/home/coder/gretel/experimental/cfgnnexplainer/results/syn1/SGD/syn1_cf_examples_lr0.005_beta0.5_mom0.0_epochs500_seed42", "rb") as f:
